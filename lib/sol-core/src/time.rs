...
///
/// Users can look at `sol_stream::batcher::ExpirationQueue` for a concrete implementation.
pub trait KeyedTimer<K> {
    ...
    ///
    /// Used primarily for property testing vis-á-vis `sol_stream::batcher::Batcher`.
