...
fn otel_value_to_str_ref(v: &OtelValueKind) -> &str {
    match v {
...
impl OtelMetric {
    ...
    /// Builder-style: set tags from legacy MetricTags (compatibility shim during migration).
    pub fn with_metric_tags(mut self, tags: Option<super::metric::MetricTags>) -> Self {
    ...
    /// Build legacy MetricTags from proto data (compatibility shim during migration).
    pub fn metric_tags(&self) -> Option<super::metric::MetricTags> {
