...
mod tests {
    ...
    fn encode_event() {
        ...
        let mut event1 = Event::from(LogEvent::from("hello world"));
        event1.as_mut_log().insert("app", "notvector");
        event1.as_mut_log().insert("magic", "vector");

        let mut event2 = Event::from(LogEvent::from("hello world"));
        event2.as_mut_log().insert("file", "log.txt");

        let event3 = Event::from(LogEvent::from("hello world"));

        let mut event4 = Event::from(LogEvent::from("hello world"));
